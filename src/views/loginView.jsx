...
export function LoginView({ email, password, loading, error, onEmailChange, onPasswordChange, onLogin, onSwitchToSignup, onResetPassword }) {
        ...
        <div className="auth-form-container">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="login-signup-submit">
              <Button text="Sign In" type="submit" loading={loading} size="large" fullWidth={true} />
            </div>
          </form>

          <p className="login-signup-switch">
            New to LeafKeeper? <a onClick={onSwitchToSignup}>Create an account</a>
          </p>
          <p className="login-signup-switch">Forgot password?! <a onClick={onResetPassword}>Reset Password</a></p>
        </div>
      </div>
    </div>
  );
